...
def iterate_pagerank(corpus, damping_factor):
    ...
    while True:
        ...
        for page in corpus:
            ...
            rank += damping_factor * (dangling_mass / N)

            # add link contributions
            for other in corpus:
                if page in corpus[other] and len(corpus[other]) > 0:
                    rank += damping_factor * (ranks[other] / len(corpus[other]))
